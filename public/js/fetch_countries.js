...
// Place this script at the end of your HTML body or wrap it in a window.onload event handler to ensure that the DOM is fully loaded before executing the script.
...
async function populateCountrySelect() {
    ...
    if (countries) {
        ...
        // Effacer les options précédentes, au cas où elles existent déjà
